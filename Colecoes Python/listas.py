...
print(lista[1:])  # Iniciando no índice 1 e pegando todos os elementos restantas

# Trabalhando com slice de lista com o parâmetro 'fim'

print(lista[:2])  # começa em 0, pega até o índice 2 - 1

print(lista[:4])  # começa em 0, pega até p índice 4 - 1

print(lista[1:3])  # começa em 1, pega até p índice 3 - 1
...
# OBS: Se tivermos um número diferente de elemementos na lista ou variáveis para receber os dados, teremos ValueError
...
# é chamamado de Deep Copy (cópia profunda)
"""
...
# Veja que utikizanos a cópia via atrbuição e copiamos os dados lista para a nova lista, mas
# após realizar modificação em uma das lisras, essa modificação se refletiu em ambas as listas.
