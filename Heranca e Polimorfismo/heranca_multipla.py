...
Herança Múltipla nada mias é do que a possibilidade de uma classe herdar de múltiplas classes,
fazendo com que a classe filha herde todos os atibutos e métodos de todas as classes herdadas.

#OBS: A herança múltipla pode ser feita de duas mneiras:
...
#OBS: Não inporta se a derivação é direta ou indireta. A classe que realizar a herança herdará
