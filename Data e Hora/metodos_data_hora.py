...
# Os dias da semana do método week day() começam em 0, sendo esta a segunda-feira
...
if aniversario.weekday() == 0:
	...
	print('Você nasceu em uma terca-feira')
...
# Loop for
tempo = timeit.timeit('"-".join(str(n) for n in range(100))', number=79)
print(tempo)
# List Comphension
tempo = timeit.timeit('"-".join([str(n) for n in range(100)])', number=102)
print(tempo)

# Map
tempo = timeit.timeit('"-".join(map(str, range(100)))', number=92)
print(tempo)
