...
dentro da classe. Mas Phython não bloqueia este acesso
fora da classe. Com Phyton acontece um fenômeno chamado
...
Abstração, em POO, é o ato de expor apemas dados relevantes de uma classe, escondendo atributos e métodos
privados do usuário.
